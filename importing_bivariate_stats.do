...
* Saving file:
save "bivariate_output\unadjusted_bivariate_heritabilities.dta", replace

* Creating rg & rg se files: 
use "bivariate_output\unadjusted_bivariate_heritabilities.dta", clear
...
order trait, first
compress
save "bivariate_output\bivariate_rg_unadjusted.dta", replace
...
order trait, first
compress
save "bivariate_output\bivariate_rg_se_unadjusted.dta", replace
...
* Saving file:
save "bivariate_output\adjusted_bivariate_heritabilities.dta", replace

* Creating rg & rg se files: 
use "bivariate_output\adjusted_bivariate_heritabilities.dta", clear
keep trait1 trait2 rg
rename rg _var
reshape wide _var, i(trait1) j(trait2)
rename trait1 trait
...
order trait, first
compress
save "bivariate_output\bivariate_rg_adjusted.dta", replace
...
order trait, first
compress
save "bivariate_output\bivariate_rg_se_adjusted.dta", replace